...
namespace JSSoft.Font
{
    public static class NamesList
    {
        ...
        public static readonly (string name, uint min, uint max)[] Items =
        {
            ...
            ("CJK Unified Ideographs", 0x4E00, 0x9FEF),
            ...
            ("Unassigned", 0x2FF80, 0x2FFFF),
            ("Unassigned", 0x3FF80, 0x3FFFF),
            ("Unassigned", 0x4FF80, 0x4FFFF),
            ("Unassigned", 0x5FF80, 0x5FFFF),
            ("Unassigned", 0x6FF80, 0x6FFFF),
            ("Unassigned", 0x7FF80, 0x7FFFF),
            ("Unassigned", 0x8FF80, 0x8FFFF),
            ("Unassigned", 0x9FF80, 0x9FFFF),
            ("Unassigned", 0xAFF80, 0xAFFFF),
            ("Unassigned", 0xBFF80, 0xBFFFF),
            ("Unassigned", 0xCFF80, 0xCFFFF),
            ("Unassigned", 0xDFF80, 0xDFFFF),
            ("Tags", 0xE0000, 0xE007F),
            ("Variation Selectors Supplement", 0xE0100, 0xE01EF),
            ("Unassigned", 0xEFF80, 0xEFFFF),
            ("Supplementary Private Use Area-A", 0xFFF80, 0xFFFFF),
            ("Supplementary Private Use Area-B", 0x10FF80, 0x10FFFF)
        };
    }
}
